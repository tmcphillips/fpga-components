...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "simple_lfsr_next_byte.autotvin.dat"
	set constFileTvOut       "simple_lfsr_next_byte.autotvout.dat"
	set constFileHdlTvIn     "simple_lfsr_next_byte.autohdltvin.dat"
	set constFileHdlTvOut    "simple_lfsr_next_byte.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
